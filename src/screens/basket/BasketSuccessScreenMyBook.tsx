...
import {resetProductToBasketMyBook} from '../../store/shop/shopSliceMyBook.ts';
import {IconComponent} from '../../components/icon/IconComponent.tsx';

interface BasketSuccsessScreenProps {}

const BasketSuccessScreenMyBook: FC<
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <TouchableOpacity
          onPress={() => {
            dispatch(resetProductToBasketMyBook());
...
export default BasketSuccessScreenMyBook;
